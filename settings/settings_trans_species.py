...
STORE_DATA_PATH = os.path.join(BASE_DATA_PATH, 'store_trans_species')
...
TRAIN_DNN = {
    ...
    'ARTIFACT_NAME': 'DNN_4_LPJG_input_trans_SGDoptim_species_sklearn.pt',
    'EPOCHS': 3000,
    'LEARN_RATE': 0.00003,
    'BATCH_SIZE': 512,
    'FEATURES': [
...
TEST_DNN = {
    'INPUT_PATH': os.path.join(STORE_DATA_PATH,'appended'),
    'OUTPUT_PATH':os.path.join(STORE_DATA_PATH, 'report', 'species_SGD'),
    'STATE_PATH': os.path.join(STORE_DATA_PATH, 'artifacts', 'DNN_4_LPJG_input_trans_SGDoptim_species_sklearn.pt'),
